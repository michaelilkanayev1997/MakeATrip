...
urlpatterns = [
    ...
    path('create-privacy-policy/', views.create_privacy_policy, name='create-privacy-policy'),
    path('update-privacy-policy/<str:pk>/', views.update_privacy_policy, name='update-privacy-policy'),
    path('delete-privacy-policy/<str:pk>/', views.delete_privacy_policy, name='delete-privacy-policy'),
