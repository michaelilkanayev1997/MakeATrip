...
[AdminLTE Django](https://appseed.us/admin-dashboards/django-dashboard-adminlte) is an open-source seed project generated by AppSeed on top of **AdminLTE**, the iconic dashboard design. For newcomers, AdminLTE is one of the best open-source admin dashboard & control panel theme. Built on top of Bootstrap, AdminLTE provides a range of responsive, reusable, and commonly used components. **Django** is a high-level Python Web framework that encourages rapid development and clean, pragmatic design.
